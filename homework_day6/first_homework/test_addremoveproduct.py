...
class TestAddremoveproduct():
  ...
  def test_addremoveproduct(self):
    ...
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "#item_5_title_link > .inventory_item_name")))
    self.driver.find_element(By.CSS_SELECTOR, "#item_5_title_link > .inventory_item_name").click()
